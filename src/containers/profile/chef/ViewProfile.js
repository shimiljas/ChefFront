/*
 * @file: ViewProfile.js
 * @description: Chef can view their profile.
 * @date: 18.07.2017
 * @author: Vishal Kumar
 * */
...
class ViewProfile extends Component {
  ...
  onVideoPress(){
    let context = this;
    let files = [...this.props.user.userDetails.workHistory] 
  ...
  render() {
    ...
    } = this.props.user.userDetails.mealsSupported;
    let typesOfDietData = "";
    ...
    let workHistoryArr = [...this.props.user.userDetails.workHistory] ;
    ...
    return (
      <View style={styles.mainView}>
        <NavigationBar
          ...
          rightButton={<EditButton title={"Edit"} onPress={()=>navigate("ChefEditProfile")} />}
        />
        <ScrollView showsHorizontalScrollIndicator={false} showsVerticalScrollIndicator={false}  style={styles.container}>
          ...
          <View style={{paddingTop: Constants.BaseStyle.DEVICE_HEIGHT*1/100}}>
            <TextField
               ...
               dataText={this.props.user.userDetails.email}
            />
            ...
            <TextField
              ...
              headerStyle={Constants.Fonts.bold}
              dataText={this.props.user.userDetails.position.address}
            />

            <TextField
              headerText={ratePerHour}
              headerStyle={Constants.Fonts.bold}
              dataText={"$ " + this.props.user.userDetails.ratePerHour}
            />

            <TextField
              headerText={experienceInYears}
              headerStyle={Constants.Fonts.bold}
              dataText={this.props.user.userDetails.expInYears}
            />

            <TextField
              headerText={milesWillingToTravel}
              headerStyle={Constants.Fonts.bold}
              dataText={this.props.user.userDetails.milesToTravel}
            />
            ...
            {
              this.props.user.userDetails.typesOfSpecializedCooking.join(', ').length > 0 &&
              <TextField
                headerText={specializedCooking}
                headerStyle={Constants.Fonts.bold}
                dataText={this.props.user.userDetails.typesOfSpecializedCooking.join(', ')}
              />
            }
            ...
            <TextField
              ...
              headerStyle={Constants.Fonts.bold}
              dataText={this.props.user.userDetails.minGuestCount}
            />

            <TextField
              headerText={maxGuaranteedGuests}
              headerStyle={Constants.Fonts.bold}
              dataText={this.props.user.userDetails.maxGuestCount}
            />
            ...
            { /*
              <TextField
                ...
                headerStyle={Constants.Fonts.bold}
                dataText={this.props.user.userDetails.criminalCase?"Yes":"No"}
              />
              */
            }

            {
              this.props.user.userDetails.describeYourself !== '' &&
              <TextField
                headerText={description}
                headerStyle={Constants.Fonts.bold}
                dataText={this.props.user.userDetails.describeYourself}
              />
            }
