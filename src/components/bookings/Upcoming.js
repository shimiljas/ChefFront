/*
 * @file: Upcoming.js
 * @description: Upcoming booking component for Upcoming booking screen
 * @date: 13.07.2017
 * @author: Vishal Kumar
 * */
    ...
    return (
      <TouchableOpacity onPress={()=>{
        ...
        <View style={[styles.profilePhotoContainerStyle, profilePhotoContainerStyle]}>
         {this.props.data.user != undefined ? <Avatar  user = {this.props.data.user} /> : null}
        </View>
        ...
        <View style={[styles.detailsContainerStyle, detailsContainerStyle]}>
          ...
          {this.props.data.hasOwnProperty("user") && this.props.data.user.role===1 && 
          ...
          {this.props.data.hasOwnProperty("user") && this.props.data.user.role===0 && this.props.data.hasOwnProperty("totalCost") &&
            <View style={[styles.paymentContainerStyle, ]}>
              <Text style={[styles.paymentStyle,Constants.Fonts.tiny]}>
                {"Amount $"+(this.props.data.totalCost - this.props.data.adminCost).toFixed(2)}
              </Text>
            </View>
          }
          </View>
          {
            ...
            <View style={[styles.additionalCostContainerStyle, additionalCostContainerStyle]}>
              <Text style={[styles.additionalCostStyle, additionalCostStyle]}>
                Additional cost: ${this.props.data.additionalCost}
              </Text>
            </View>
          } 
