...
export default class Day extends Component {
  ...
  static propTypes = {
    ...
    bookingFullDates: PropTypes.object,
        ...
        <View style={[styles.dayButton, customStyle.dayButton, isWeekend ? styles.weekendDayButton : null]}>
         ...
         {showEventIndicators &&
            <View style={[
              ...
              (isToday && event) && event.eventIndicator, 
              ((isSelected && event) )  && customStyle.eventIndicatorToday, // for white eventindicator 
              bookingFullDates && customStyle.bookingFullDates, // for red eventindicator 
              ((isSelected) && (isToday && bookingFullDates))   && customStyle.eventIndicatorToday,
              ((isSelected  && bookingFullDates))   && customStyle.eventIndicatorToday,
              ]}
            />
          }
          </View>
